...
logging.basicConfig(
            ...
            filename='get_peppapig.log',
            level=numeric_level
)

logger = logging.getLogger('get_peppapig.py')


# Environment variables
# source_url = 'http://pluzz.francetv.fr/videos/peppa_pig.html'
source_url = 'http://pluzz.francetv.fr/videos/peppa_pig_,120484003.html'
save_path = '/home/jeff/Videos/sortie/peppapig/'
...
rname = re.compile(r'http://.+/peppa_pig_saison(?P<saison>\d+)'
...
try:
    ...
    names = [dldir + '/' + 'Peppa Pig - S%02dE%02d_%d.mp4' %
